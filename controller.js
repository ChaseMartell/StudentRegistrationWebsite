function onPageLoad() {
    ...
    //Populate the table from all students in the model
...
function onDeleteBtnClicked(id) {
    ...
    if (!confirm("Are you sure you would like to delete " + student.firstName + " " + student.lastName + "?")){
        return;
    }
...
function onUpdateBtnClicked(id) {
    ...
    //Reset the Form and show the list of students.
    clearInputForm();
}
...
function validateControls() {
    ...
    if (form.firstNameEdit.value === "") {
        document.getElementById("firstNameError").innerText = "First name needs to be given."
        isValidated = false;
    } else {
    ...
    if (form.lastNameEdit.value === "") {
        document.getElementById("lastNameError").innerText = "Last name needs to be given."
        isValidated = false;
    } else {
    ...
    if (!form.genderMaleRadio.checked && !form.genderFemaleRadio.checked) {
        document.getElementById("genderError").innerText = "Gender not selected.";
        isValidated = false;
    } else {
    ...
    if (form.uvuIdEdit.value === "") {
        document.getElementById("uvuIdError").innerText = "UVU ID not entered.";
        isValidated = false;
        ...
        document.getElementById("uvuIdError").innerText = "UVU ID must be eight digits."
        isValidated = false;
    } else {
    ...
    if (form.ageEdit.value === "") {
        ...
        document.getElementById("ageError").innerText = "Age must be between 1 and 110";
        isValidated = false;
    } else {
