...
function modelCreateStudent(
    ...
    var newStudent = new Student(firstName, lastName, male, uvuId, race, age, isVeteran);
...
function modelUpdateStudent(id, firstName, lastName, male, uvuId, race, age, isVeteran) {
